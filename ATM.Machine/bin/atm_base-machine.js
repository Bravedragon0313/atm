...
function bail (err) {
  if (bailed) return
  bailed = true
  console.log('atm_base-machine bailing out momentarily...')
  console.log(err)
  if (err.stack) console.log(err.stack)
  setTimeout(function () {
    console.log('atm_base-machine bailing out')
    process.exit(10)
...
process.on('exit', function () { console.log('atm_base-machine exiting') })
